...
Networking becomes less about hoping and more about *knowing*. With StrongTies you get actionable insight into who to connect with — and how to do it in a way that supports your goals, while honouring your network.
...
## How It Works  
1. **Export Connection Data** – Export your LinkedIn connections, providing name + company fields only.  
...
> _All processed locally or via open-source code; no sensitive data is shared._
