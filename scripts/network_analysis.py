...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Analyze professional social network metrics.")
    parser.add_argument("--graph", type=str, default="results/figures/network.graphml", 
                        help="Path to input graph file")
    parser.add_argument("--output_dir", type=str, default="results/reports", 
